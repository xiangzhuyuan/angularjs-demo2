    ...
    e.module("ngResource", ["ng"]).factory("$resource", ["$http", "$parse", function (x, y) {
        ...
        function u(a, f, b) {
            function d(b, c) {
                ...
                l(c, function (o, c) {
                    var d;
                    o.charAt && o.charAt(0) == "@" ? (d = o.substr(1), d = y(d)(b)) : d = o;
                    a[c] = d
                });
                return a
            }
            ...
            l(b, function (g, c) {
                ...
                h[c] = function (a, b, c, f) {
                    ...
                    x({method: g.method, url: e.url(i({}, d(j, g.params || {}), s)), data: j}).then(function (a) {
                        var b = a.data;
                        if (b)g.isArray ? (n.length = 0, l(b, function (a) {
                            n.push(new h(a))
                        })) : v(b, n);
                        (m || p)(n, a.headers)
                    }, q);
        ...
        }, p = e.noop, l = e.forEach, i = e.extend, v = e.copy, r = e.isFunction;
        t.prototype = {
            url: function (a) {
