...
(function (U, ca, p) {
    ...
    }, Ba = Q.cache = {}, Aa = Q.expando = "ng-" + (new Date).getTime(), oc = 1, Zb = U.document.addEventListener ? function (b, a, c) {
    ...
    Bb.$inject = ["$provide"];
    var Ac = /^(x[\:\-_]|data[\:\-_])/i, Fb = /^([^:]+):\/\/(\w+:{0,1}\w*@)?([\w\.-]*)(:([0-9]+))?(\/[^\?#]*)?(\?([^#]*))?(#(.*))?$/, $b = /^([^\?#]*)?(\?([^#]*))?(#(.*))?$/, Hc = $b, Gb = {
        http: 80,
        https: 443,
        ftp: 21
    };
    ...
    var Ka = {
        ...
        "'": "'",
        '"': '"'
    }, hb = {}, Yc = U.XMLHttpRequest || function () {
            try {
